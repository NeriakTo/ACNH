...
2. 石斧可伐木與敲大石頭，然一開始只能在小範圍活動時，先別吃特產水果增加力量把石頭給砸了，會影響石頭材料的取得，多砍樹拔草拿去賣錢是個不錯的選項；因為反作用力的關係，敲石頭會後退，可以在左右兩側及身後放家具（或者挖洞）卡住位置，然後猛敲（譬如敲錢的時候…）

3. 關於砸大石頭的時機，個人認為若是你的開島時間在晚上才開始遊玩，那麼睡前把大石頭都砸掉看有沒有鐵礦石是個不錯的方式，若你開島時間在白天，那麼第一天會比較長，先不要砸掉大石頭保留可蒐集石頭材料。

4. 蟲類蒐集需要捕蟲網，同時海灘上的寄居蟹（這算蟲類？！）、岩石上的海蟑螂也能用捕蟲網抓，搖樹偶爾會有蓑衣蟲降下來，拔草偶爾會有鼠婦在地上爬，遇到蜘蛛也能挑戰一下…

5. 釣魚的時候除了看浮標之外，聽聲音（上鉤會有沉重的咚聲）、靠震動都是不錯的拉竿時機，各種水源不同有不同的魚種，釣魚致富不是問題，為了保留生物給博物館，魚、蟲類都可以當作裝飾品擺放在帳篷四周（帳棚內就堆各類木材吧…），其餘的都能拿去賣錢。

6. 釣魚釣到空罐時，會想到家具 DIY 方程式「多肉植物」，用雜草 10 顆、空罐 1 個製作。

7. 當鏟子製作完成後，可至個人帳篷（房屋）門口信箱收信，媽媽寄來的信件當中會隨機有三個特產水果，鏟子挖個洞打開道具欄後可以選擇該水果種植。

8. 閒逛過程中發現草皮上發光可以用鏟子挖，會拿到一包鈴錢，可以開啟收下鈴錢或者再埋回去，會成為搖錢樹。

9. 沙灘上發現噴水的地方，以鏟子挖會找到蛤蜊，第一次挖到會想到 DIY 方程式「魚飼料」，可以用來吸引魚出現。
